...
export default function MoneyPlanPage() {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Today's Money Plan</h1>
              <p className="text-sm text-muted-foreground">{openItems.length} actions to grow your revenue</p>
            </div>
          </div>
          <Button
            variant="outline"
  ...
  if (!flag?.enabled) {
    return (
      <div className={`flex flex-col min-h-full bg-background ${isMobile ? "p-4" : "max-w-7xl mx-auto w-full px-6 lg:px-8 py-6"}`} data-testid="page-money-plan-disabled">
