...
const OPTIONAL_VARS: { key: string; description: string }[] = [
  {
    ...
    description: 'Platform webhook secret (needed for stripe.platform.webhook tests)',
  },
  {
    key: 'STRIPE_CONNECT_WEBHOOK_SECRET',
    description: 'Connect webhook secret (needed for stripe.connect.webhook tests)',
  },
  {
    key: 'STRIPE_SECRET_KEY',
    description: 'Stripe secret key (needed for Stripe webhook signature generation)',
  },
];
